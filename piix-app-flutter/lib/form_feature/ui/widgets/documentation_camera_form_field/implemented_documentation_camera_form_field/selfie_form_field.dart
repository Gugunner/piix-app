...
final class SelfieFormField extends BaseAppDocumentationCameraFormField {
  const SelfieFormField({
    super.key,
  ...
  @override
  State<StatefulWidget> createState() => _SelfieFormFieldState();
}

final class _SelfieFormFieldState
    extends BaseAppDocumentationCameraFormFieldState<SelfieFormField> {
  @override
  String get hintText =>
      context.localeMessage.takeAPictureOfYourselfWithOfficialIdentification;
