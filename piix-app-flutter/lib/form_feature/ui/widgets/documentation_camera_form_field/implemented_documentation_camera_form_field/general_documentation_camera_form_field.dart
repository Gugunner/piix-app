...
final class GeneralDocumentationCameraFormField
    extends BaseAppDocumentationCameraFormField {
  const GeneralDocumentationCameraFormField({
    super.key,
  ...
  State<StatefulWidget> createState() =>
      _GeneralDocumentationCameraFormFieldState();
}

final class _GeneralDocumentationCameraFormFieldState
    extends BaseAppDocumentationCameraFormFieldState<
        GeneralDocumentationCameraFormField> {
  @override
