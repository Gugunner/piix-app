...
import 'package:piix_mobile/env/env.dart';
...
Future<void> main() async {
  ...
  await setupGetIt();
  setUpEndpoints();
  PiixLoggerFilter.loggerBuild = PiixLoggerBuild.release;
...
void setUpEndpoints() {
  AppConfig.instance
    ..setBackendEndPoint(Env.backendEndpointOne)
    ..setCatalogSQLURL(Env.catalogEndpointOne)
    ..setSignUpEndpoint(Env.signUpEndpoint)
    ..setPaymentEndpoint(Env.paymentEndpoint)
    ..setPiixAppS3(Env.piixAppS3);
}
